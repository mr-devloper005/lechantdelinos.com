...
const inputClass = 'h-12 rounded-xl border border-[var(--editable-border)] bg-white px-4 text-base font-bold text-[#092f2c] outline-none transition placeholder:text-[#6f8580] focus:border-[#0b7669] focus:ring-4 focus:ring-[#0b7669]/10'
const buttonClass = 'inline-flex h-12 items-center justify-center rounded-xl bg-[#0b1d2e] px-6 text-sm font-black uppercase tracking-[0.12em] text-white shadow-sm transition hover:-translate-y-0.5 disabled:opacity-60'
